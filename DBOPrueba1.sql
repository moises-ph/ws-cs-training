...
as
begin
	SELECT P.PRODUCTOID, (select prov.NOMBREPROV from PROVEEDORES prov where prov.PROVEEDORID = P.PROVEEDORID) as 'PROVEEDORID', (select NOMBRECAT from CATEGORIAS C where C.CATEGORIAID = P.CATEGORIAID) as 'CATEGORIAID', P.DESCRIPCION, P.PRECIOUNIT, P.EXISTENCIA FROM PRODUCTOS P
end

create procedure GetAllProveedores as begin SELECT * FROM PROVEEDORES end

create procedure GetAllCategorias as begin SELECT * FROM CATEGORIAS end
...
as
begin
	INSERT INTO PRODUCTOS(PRODUCTOID, PROVEEDORID, CATEGORIAID, DESCRIPCION, PRECIOUNIT, EXISTENCIA) values (@PRODUCTOID, @PROVEEDORID, @CATEGORIAID, @DESCRIPCION, @PRECIOUNIT,@EXISTENCIA)
end